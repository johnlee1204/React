...
function downloadGreentext() {
    html2canvas(document.querySelector("#greentext-container")).then(canvas =>
    {
        let check = false;
        ...
        if(check) {//Mobile
            ...
            document.getElementsByClassName("greentext")[0].appendChild(image);
            image.src = canvas.toDataURL();
            image.className = "greentext-container";
            image.id = "greentextImage";
            document.getElementsByClassName("greentext-mobile-saveimagebelow")[0].style.display = "block";
        } else {//Desktop
            const anchorTag = document.createElement("a")
            document.body.appendChild(anchorTag);
            anchorTag.download = "greentext.jpg";
...
export default function GreenText(props) {
    return (
        <div className="greentext">
            <div id="greentext-container" className="greentext-container">
                <GreenTextHeader
                    key={props.postId}
